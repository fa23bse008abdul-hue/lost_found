        ...
        <div class="col-lg-7">
            <div class="panel-card p-4 p-lg-5 h-100">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                    <div>
                        <span class="badge badge-soft rounded-pill px-3 py-2 mb-2">Found item details</span>
                ...
                <div class="row g-3 mt-1">
                    <div class="col-md-6">
                        <div class="small text-uppercase text-muted fw-semibold">Found at</div>
        ...
        <div class="col-lg-5">
            ...
            <div class="panel-card p-4 p-lg-5">
                <div class="d-grid gap-2">
                    <a href="{{ route('found-items.index') }}" class="btn btn-outline-dark">Back to reports</a>
                    @if (auth()->id() === $item->user_id)
                        <a href="{{ route('found-items.edit', $item) }}" class="btn btn-accent">Edit report</a>
                        <form method="POST" action="{{ route('found-items.destroy', $item) }}" onsubmit="return confirm('Delete this report?');">
                            @csrf
                            @method('DELETE')
